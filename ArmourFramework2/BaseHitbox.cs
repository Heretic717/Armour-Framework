...
public partial class BaseHitbox : RigidBody3D
{
	...
	public override void _PhysicsProcess(double delta)
	{
		...
		if (collision != null)
		{
			//EmitSignalBodyEntered((Node3D)collision.GetCollider());
			OnHit((Node3D)collision.GetCollider());
		}
	}
	...
	{
		GD.Print("relative angle is " + relativeAngle);
